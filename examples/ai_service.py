...
def ai_stream_service(context, base_url=None, model_id=None, mcp_tools=None) -> tuple:
    ...
    Args:
        ...
        mcp_tools: List of MCP tools to include in the agent.
    ...
    """
    agent = get_graph_closure(model_id=model_id, base_url=base_url, mcp_tools=mcp_tools)
